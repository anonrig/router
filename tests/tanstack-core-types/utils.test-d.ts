...
import type { PartialMergeAll } from '@tanstack/router-core/utils'

describe('PartialMergeAll', () => {
  test('should be `undefined` if `TUnion` is `undefined`', () => {
    expectTypeOf<PartialMergeAll<undefined>>().branded.toEqualTypeOf<undefined>()
  })
  ...
  test('should be `null | undefined` if `TUnion` is `null | undefined`', () => {
    expectTypeOf<PartialMergeAll<null | undefined>>().branded.toEqualTypeOf<null | undefined>()
  })
  ...
  test('should merge two objects', () => {
    expectTypeOf<PartialMergeAll<{ foo: string } | { bar: number }>>().branded.toEqualTypeOf<
  ...
  test('should merge undefined and two objects', () => {
    expectTypeOf<PartialMergeAll<undefined | { bar: number } | { foo: string }>>().toEqualTypeOf<
      undefined | { bar?: number; foo?: string }
    >()
  })

  test('should merge undefined and two objects with same prop', () => {
    expectTypeOf<PartialMergeAll<undefined | { bar: number } | { bar: string }>>().toEqualTypeOf<
      undefined | { bar?: number | string }
    >()
  })
