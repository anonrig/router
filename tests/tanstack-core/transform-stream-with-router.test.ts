...
import { GLOBAL_TSR, TSR_SCRIPT_BARRIER_ID } from '@tanstack/router-core/ssr/constants'
import { createSsrStreamResponse } from '@tanstack/router-core/ssr/handlerCallback'
import { attachRouterServerSsrUtils } from '@tanstack/router-core/ssr/ssr-server'
import {
  transformPipeableStreamWithRouter,
  transformReadableStreamWithRouter,
  transformStreamWithRouter,
} from '@tanstack/router-core/ssr/transformStreamWithRouter'
import { createTestRouter } from './router-test-utils'
import type { RouterManagedTag } from '@tanstack/router-core/manifest'
