...
import { getScrollRestorationScriptForRouter } from '@tanstack/router-core/scroll-restoration-script/server'
import { BaseRootRoute, BaseRoute, storageKey } from '@tanstack/router-core'
